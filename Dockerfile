...
RUN opam pin add -yn sihl https://github.com/oxidizing/sihl.git\#0.0.30 && \
        opam pin add -yn sihl_postgresql https://github.com/oxidizing/sihl.git\#0.0.30 && \
        opam pin add -yn sihl_admin https://github.com/oxidizing/sihl.git\#0.0.30 && \
        opam pin add -yn sihl_session https://github.com/oxidizing/sihl.git\#0.0.30 && \
        opam pin add -yn sihl_session_postgresql https://github.com/oxidizing/sihl.git\#0.0.30 && \
        opam pin add -yn sihl_email https://github.com/oxidizing/sihl.git\#0.0.30 && \
        opam pin add -yn sihl_email_postgresql https://github.com/oxidizing/sihl.git\#0.0.30 && \
        opam pin add -yn sihl_user https://github.com/oxidizing/sihl.git\#0.0.30 && \
        opam pin add -yn sihl_user_postgresql https://github.com/oxidizing/sihl.git\#0.0.30 && \
